    ...
    <div className=' grid grid-cols-1 md:grid-cols-3  items-start'>
      {
        jobs?.map(x => {
          return <div className='flex flex-col gap-3  hover:bg-gray-800 text-white rounded-xl m-3 overflow-hidden border' key={x._id}>
            <h1 className='font-[impact] text-[30px] p-1 hover:underline'>{x.companyname}</h1>
            ...
            <button className='bg-white text-gray-500 duration-300 hover:text-black p-1 rounded-md'>Apply</button>
