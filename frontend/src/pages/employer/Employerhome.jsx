  ...
  return (
    <div className="min-h-screen w-full  bg-[#020617] relative ">
      ...
      <div className='   flex flex-col md:flex-row h-40  border-t-5 text-white backdrop-blur-sm p-4 '>
        <div className='flex-5 bg-gray-900  shadow-[0_0_10px_rgba(0,0,0,8.25)]  rounded-xl backdrop-blur-4xl flex justify-center items-center text-2xl sm:text-none '>
        ...
        <div className='flex-2  shadow-[0_0_10px_rgba(0,0,0,8.25)] flex bg-gray-900 justify-center items-center ml-2 rounded-xl'>
          <h1 >
