...
const Employerhome = () => {
  return (
    ...
    <div className=" flex-grow overflow-y-auto bg-[#020617] relative ">
      ...
      <div className='   flex  gap-3  flex-col md:flex-row   border-t-5 text-white backdrop-blur-sm p-4 '>
        <div className='flex-5 bg-gray-900  shadow-[0_0_10px_rgba(0,0,0,8.25)]  rounded-xl backdrop-blur-4xl p-4 flex justify-center items-center text-2xl sm:text-none  '>
          <h1 className='font-light md:text-3xl flex '> <span className='text-gray-400'>Post </span> job Vacancies <span className='text-gray-400'>Here </span> : <Link className='bg-gray-500 active:scale-90 rounded-md p-1 hover:bg-gray-600 duration-200' to={'/jobregister'}>register</Link> </h1>
        </div>
